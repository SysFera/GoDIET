...
Avant de pouvoir utiliser \godiet, vous devez créer trois fichiers 
...
%%Physical platform
\godiet needs to have the description of infrastructure on which \diet will be running.
