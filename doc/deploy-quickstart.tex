...
Dans cette partie nous allons lancer une hierarchie \diet très simple
avec \godiet. Pour simplifier encore les choses, \diet et \godiet
seront executer sur la même machine. Les pré-requis pour réaliser ce
...
Remplacer myPrivateKeyPaht par le chemin associé à votre clef SSH.
