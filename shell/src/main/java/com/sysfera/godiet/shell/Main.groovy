 ...
 *
 * @version $Id: Main.groovy 19981 2010-05-08 11:51:20Z paulk $
...
class Main {
	...
	static void main(final String[] args) {
		...
		def cli = new CliBuilder(usage : 'godietsh [options] [...]', formatter: new HelpFormatter(), writer: io.out)
		...
		if (options.hasOption('D')) {
			...
			values.each { setSystemProperty(it as String) }
		}
