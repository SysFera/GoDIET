...
public class XmlScannerJaxbImpl implements XMLParser{ 
	 ...
	 */
	// private void initDataModel(DietConfiguration dietConfiguration) throws
	// XMLReadException
	// {
	//
	// // //GoDietConfig
	...
	// //
	// // List<Domain> domains =
	// dietConfiguration.getInfrastructure().getDomain();
	...
	// private void processClusters(List<Cluster> clusters, Domain domain)
	// throws XMLReadException {
	// if(clusters !=null) throw new XMLReadException("Not yet implemented");
	//
	// }
	//
	// private void processGateways(List<Gateway> gateways, Domain domain)
	// throws XMLReadException {
	// if(gateways !=null) throw new XMLReadException("Not yet implemented");
	// }
	//
	// private void processComputes(List<Node> computes, Domain domain) throws
	// XMLReadException {
	...
	// for (Domain domain : domains) {
	// com.sysfera.godiet.Model.Domain domainResource = new
	// com.sysfera.godiet.Model.Domain();
	...
	// * @throws XMLReadException
	// */
	// private void procesStorages(List<Storage> storages,Domain domain) throws
	// XMLReadException{
	// if(storages != null)
	// {
	...
	// }
	// /**
	// * Process storage node. Control and add a Storage resource in
	// DietPlatformController
	// * @param storage The XML node storage
	// * @param domain the requested domain
	// * @throws XMLReadException if domain not declared before.
	// */
	// private void processStorage(Storage storage,Domain domain) throws
	// XMLReadException{
	// com.sysfera.godiet.Model.Domain domainDiet =
	// mainController.getResourcePlatform().getDomain(domain.getLabel());
	// if(domainDiet == null) throw new
	// XMLReadException("Oooups Runtime parsing problem. Domain not found ");
