 ...
 *       &lt;sequence>
 *         &lt;element name="ssh" type="{http://www.sysfera.com}ssh"/>
...
@XmlType(name = "resource", propOrder = { "ssh", "env", "endPoint" })
...
public abstract class Resource {
	...
	public void afterUnmarshal(Unmarshaller u, Object parent) {
		if (parent instanceof Resource)
			this.domain = ((Resource) parent).getDomain();
	 ...
	 * 
	 * @return possible object is {@link Env }
	 * 
	 */
	public Env getEnv() {
		return env;
