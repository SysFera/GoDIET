...
public class DietManager {
	...
	private final List<DietServiceManaged<OmniNames>> omninames;
	...
	public DietManager(DomainsManager domainManager) {
		...
		this.omninames = new ArrayList<DietServiceManaged<OmniNames>>();
	 ...
	 */
	public List<DietServiceManaged<OmniNames>> getOmninames() {
		return omninames;
	}
	 ...
	 * @throws DietResourceCreationException
	 */
	public void addOmniName(DietServiceManaged<OmniNames> omniName) throws DietResourceCreationException {
	 ...
	 */
	public DietServiceManaged<OmniNames> getManagedOmniName(Node node) {
		if(node == null)
		{
			log.error("Node Null");
			return null;
		...
		for (Ssh ssh : sshs) {
			...
			for (DietServiceManaged<OmniNames> manageOmni : omninames) {
