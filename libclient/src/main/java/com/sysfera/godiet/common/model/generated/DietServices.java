...
// Generated on: 2011.06.27 at 08:58:54 AM CEST 
//
 ...
 *         &lt;element name="forwarders" type="{http://www.sysfera.com}forwarders" maxOccurs="unbounded" minOccurs="0"/>
...
public class DietServices implements Serializable{

    @XmlElement(required = true)
    protected List<OmniNames> omniNames;
    protected List<Forwarders> forwarders;
    ...
    /**
     * Gets the value of the forwarders property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the forwarders property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getForwarders().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Forwarders> getForwarders() {
        if (forwarders == null) {
            forwarders = new ArrayList<Forwarders>();
        }
